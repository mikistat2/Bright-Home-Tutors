        ...
        <div style={{
          ...
          >
            ...
            <p style={{
              ...
              <span className="text-amber-400 text-3xl text-bold">ብሩህ አስጠኚዎች ድርጅት</span>ብሩህ አስጠኚዎች ድርጅት በአዲስ አበባ የቤት ለቤት እና ኦንላይን የማስጠናት አገልግሎት የሚሰጥ ድርጅት ሲሆን በመምህራን አና ከዩኒቨርስቲ በጥሩ ዉጤት በተመረቁ ወጣቶች ለሁለት አመታት የተማሪዎችን ውጤት በማሻሻል ብዙ ስራዎችን ሰርተናል.ለብሄራዊ ተፈታኞች ልዩ ትኩረት መስጠታችን እና ከወላጆች ጋር አንድ ላይ መስራታችን ልዩ ያደርገናል።
